...
const ignoreList = process.env.IGNORE_CHANNELS
  ? process.env.IGNORE_CHANNELS.split(",")
  : [];
...
console.log(
  `\nRemote Console Personal Server ver: ${version} host: ${
    process.env.SERVER_PROTOCOL
  }://${process.env.SERVER_DOMAIN} env: ${
