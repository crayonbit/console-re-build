...
!(function (e, t) {
  ...
  return (() => {
    var __webpack_modules__ = {
        87: (
          ...
          const io = __webpack_require__(751),
            { printStackTrace } = __webpack_require__(96),
            { matchMedia, VISIBILITY, IEArraysPolyfill, isArray } =
              __webpack_require__(806),
            { kindOf } = __webpack_require__(554),
            { XBBCODE } = __webpack_require__(655),
          ...
          var name = "toServerRe",
            ...
            consolereScriptTag =
              document.getElementById("consolerescript") || null;
          if (consolereScriptTag) {
            var options = consolereScriptTag.getAttribute("data-options");
            options &&
              -1 !== options.indexOf("redirectDefaultConsoleToRemote") &&
              (consoleReOptions.redirectDefaultConsoleToRemote = !0),
              options &&
                -1 !== options.indexOf("disableDefaultConsoleOutput") &&
                (consoleReOptions.disableDefaultConsoleOutput = !0),
              (consoleReOptions.channel =
                consolereScriptTag.getAttribute("data-channel") ||
                consoleReOptions.channel),
              (consoleReOptions.server =
                consolereScriptTag.getAttribute("data-server") ||
                consoleReOptions.server);
          }
            ...
            return (
              void 0 !== n
                ? null === (t = n.match(/^.*([\/<][^\/>]*>?):(\d*):(\d*)?$/)) &&
                  (t = n.match(/^.*([\/<][^\/>]*>?):(\d*)?$/))
                : ((t[1] = ""), (t[2] = "0"), (t[3] = "0")),
              { file: t ? t[1] : "", line: t ? t[2] : "0", col: t ? t[3] : "0" }
            );
          }
          ...
          function stringify(e, t, n) {
            ...
            return JSON.stringify(e, function (e, l) {
                ...
                if ("css" === t) {
                  ...
                  if (n)
                    return (
                      (o = " " + n + ":" + getStyle(l, n) + ";"),
                      c &&
                        (c = " [attr]id=[/attr][string]'" + c + "'[/string]"),
                      u &&
                        (u =
                          " [attr]class=[/attr][string]'" + u + "'[/string]"),
                      "[tag]<" +
                        l.nodeName +
                        c +
                        u +
              ...
              if ("object" == typeof l && null !== l) {
                ...
                if (
                  (l.length && p.length === l.length && (l = p),
                  -1 !== (r = s.indexOf(l)))
                )
                  return "[ Circular {" + (i[r] || "root") + "} ]";
                s.push(l), i.push(e);
              }
              return l;
            });
          ...
          var root = (function () {
                  ...
                  "command" !== e &&
                    t.forEach(function (t) {
                      ...
                      !(function (e, t) {
                        ...
                        var n = {};
                        n =
                          consoleReOptions.redirectDefaultConsoleToRemote &&
              ...
              function l(i, a, c) {
                ...
                if ("css" === (c = c || ""))
                  (d = a[a.length - 1]),
                    isArray(d) || "string" == typeof d ? a.pop() : (c = "");
                else if ("count" === c)
                  (p = a.toString()),
                    isNaN(r[p]) ? (r[p] = 1) : r[p]++,
                    a.push(r[p]);
                  ...
                  (h = a.toString()),
                    ...
                    a.push("[white]started[/white]");
                else if ("timeEnd" === c)
                  (h = a.toString()),
                    (f = new Date().getTime() - s[h]),
                    isNaN(f)
                      ? a.push("[white]not started[/white]")
                      : a.push(
                          "[white]ends[/white] in [number]" + f + "[/number] ms"
                        );
                else if ("now" === c) {
                  var y,
                    b,
                  ...
                  o[w]
                    ? ((y = v - o[w]),
                      (b = " [color=gray]from last call[/color]"))
                    : ((y = v),
                      (b = " [color=gray]from navigation start[/color]")),
                    (o[w] = v),
                    (w =
                      "-" !== w
                        ? b + "[color=gray] at `" + w + "` [/color]"
                        : b),
                    (a = []).push(
                      "[white]performance now is[/white] [number]" +
                        y.toFixed(2) +
                        "[/number] ms" +
                        w
                    );
                ...
                "object" != typeof a || a.length
                  ...
                  : (l = a),
                  e ? (n.length && g(n), e.emit(name, l)) : n.push([i, l]);
              }
              ...
              function d() {
                if (e) {
                  var t =
                    ...
                    consoleReOptions.channel +
                    "`";
                  window.consoleDefault && consoleDefault.log
                    ? consoleDefault.log(t)
                    : console.log(t),
                    e.emit("channel", consoleReOptions.channel);
                }
                g(n);
              }
              function g(e) {
                var t = e.shift();
                for (
                  a._dispatch("command", "", "autoclear"),
                    a._dispatch("command", "", "automark");
                  t;

                )
                  l.apply(null, t), (t = e.shift());
              }
              return (
                (a.connectIO = function (t) {
                  isLocal || isPrivate
                    ? io
                      ? ((e = io.connect(consoleReOptions.server, {
                          withCredentials: !1,
                        ...
                        e.on("connect_failed", function () {
                          var e =
                            "consoleRe [error] connection failed to server `" +
                            consoleReOptions.server +
                            "`";
                          window.consoleDefault && consoleDefault.error
                            ? consoleDefault.error(e)
                            : console.error(e);
                        }))
                      : t || a.connectIO(!0)
                    : console.warn(
                ...
                (a.size = a.s =
                  function (e) {
                    e && void 0 !== e && "window" !== e
                      ? a._dispatch("size", [].slice.call(arguments), "size")
                      : a._dispatch("size", [getWindowSize()]);
                  }),
                (a.count = a.c =
                  function () {
                ...
                (a.trace = a.tr =
                  function () {
                    ...
                    for (h = 0; e.length > h; h++)
                      /console.re.js/gi.test(e[h]) || t.push(e[h]);
                ...
                (a.test = a.ts =
                  function () {
                    ...
                    e.forEach(function (e) {
                      var r;
                      (t = kindOf(e)),
                        /|Function|Object|Array|Element|/gi.test(t) &&
                          (t = "[color=#BBB519]" + t + "[/color]");
                      try {
                  ...
                  function () {
                    ...
                    e.forEach(function (n, r) {
                      "string" != typeof n &&
                        (n ||
                          ("string" == typeof e[r + 1]
                            ? t.push("[color=red]" + e[r + 1] + "[/color]")
                            : t.push("[color=red]Assertion Failure[/color]")));
                    }),
                ...
                (a._dispatch = function (n, r, o, s) {
                  !(function (n, r, o, s) {
                    (t = s || getCaller()),
                      ((r.length && -1 !== c.indexOf(n)) || "command" === n) &&
                        (a.client &&
                          !1 === consoleReOptions.disableDefaultConsoleOutput &&
                ...
                (a.media = a.mq =
                  function (e, t) {
                    ...
                    function g() {
                      var e = [];
                      for (var t in s)
                        s[t].matches && e.push(replaceWithNum(s[t].media));
                      return e;
                    }
                    !(function () {
                      var e,
                      ...
                      if (l)
                        for (e = t.length - 1; e >= 0; e--)
                          d(t[e]) || s.push(window.matchMedia(t[e]));
                      if (u) {
                        var n = document.getElementsByTagName("link");
                        for (e = n.length - 1; e >= 0; e--)
                          n[e].media && s.push(window.matchMedia(n[e].media));
                      }
                    })(),
                      (n = g()).length
                        ? 1 === n.length
                          ? c.push(g()[0])
                          : c.push(g())
                        : c.push("[yellow]No Media Query Rules[/yellow]"),
                      "w" === e
                        ? (c.push(getWindowSize()),
                          i &&
                            (90 !== Math.abs(window.orientation) &&
                              (p = "portrait"),
                            c.push("Orientation: [yellow]" + p + "[/yellow]")),
                          a._dispatch("media", c, "", t))
                        : a._dispatch("media", c);
                  }),
                (a.now = a.n =
                  function (e) {
                ...
                (a.redirectDefaultLog = function () {
                  if (
                    ...
                    [
                      ...
                      (window.consoleDefault[e] = console[e]),
                        (console[e] = f(e));
                    });
                  }
                }),
                a.redirectDefaultLog(),
                a
              );
            })(),
            perfNow = function () {
              ...
              return "undefined" != typeof performance &&
                ...
                ? ((t = process.hrtime),
                  ...
                  (e() - r) / 1e6)
                : Date.now
                ? ((n = Date.now()), Date.now() - n)
                : ((n = new Date().getTime()), new Date().getTime() - n);
            },
            BrowserDetect = {
              searchString: function (e) {
                for (var t = "", n = 0; n < e.length; n++) {
                  var r = e[n].str,
                    o = e[n].prop;
                  if (
                    ((this.versionSearchString = e[n].vsearch || e[n].name),
                    r && -1 !== r.indexOf(e[n].substr))
                  ) {
                    t = e[n].name;
                    break;
                  }
              ...
              searchVersion: function (e) {
                ...
                return (
                  -1 !== t &&
                  parseFloat(e.substr(t + this.versionSearchString.length + 1))
                );
              },
              dataBrowser: [
                {
                ...
                },
                {
                  str: navigator.userAgent,
                  substr: "Netscape",
                  name: { f: "Netscape", s: "NS" },
                },
                {
                  str: navigator.userAgent,
                  substr: "MSIE",
                  name: { f: "Explorer", s: "IE" },
                  vsearch: "MSIE",
                },
                {
                  str: navigator.userAgent,
              ...
              dataOS: [
                { str: navigator.platform, substr: "Win", name: "Win" },
                { str: navigator.platform, substr: "Mac", name: "Mac" },
                { str: navigator.userAgent, substr: "iPhone", name: "iOS" },
                { str: navigator.userAgent, substr: "iPad", name: "iOS" },
                {
                  str: navigator.userAgent,
                  substr: "Android",
                  name: "Android",
          ...
          (window.onerror = handleError),
            (window.ConsoleRe = !0),
            (window.ConsoleReConnectorVersion = "2.1.17"),
            (root.connect = function (e) {
              return (
                null != e &&
                  (null != e.redirectDefaultConsoleToRemote &&
                    (consoleReOptions.redirectDefaultConsoleToRemote =
                      e.redirectDefaultConsoleToRemote),
                  null !== e.disableDefaultConsoleOutput &&
                    (consoleReOptions.disableDefaultConsoleOutput =
                      e.disableDefaultConsoleOutput),
                  null != e.channel && (consoleReOptions.channel = e.channel),
                  null != e.server && (consoleReOptions.server = e.server)),
                      ...
                      ("0" !== e(n, "opacity") &&
                        ...
                        !u ||
                          ((("hidden" !== e(u, "overflow") &&
                            "scroll" !== e(u, "overflow")) ||
                            !(
                              i + 2 > u.offsetWidth + u.scrollLeft ||
                              i + a - 2 < u.scrollLeft ||
                              r + 2 > u.offsetHeight + u.scrollTop ||
                              r + c - 2 < u.scrollTop
                            )) &&
                            (n.offsetParent === u &&
                              ((i += u.offsetLeft), (r += u.offsetTop)),
                            t(u, r, o, s, i, a, c))))))
                  );
                },
              };
            ...
            s = function () {
              Array.prototype.indexOf ||
                (Array.prototype.indexOf = function (e, t) {
                  null == t
                    ? (t = 0)
                    : t < 0 && (t = Math.max(0, this.length + t));
        ...
        96: (t, n, r) => {
          "use strict";
          r.r(n), r.d(n, { printStackTrace: () => o });
          var o = function (e) {
            var t = (e = e || { guess: !0 }).e || null,
              n = !!e.guess,
              r = e.mode || null,
          ...
          (o.implementation = function () {}),
            (o.implementation.prototype = {
              run: function (e, t) {
                return (
                  (e = e || this.createException()),
                  "other" === (t = t || this.mode(e))
                    ? this.other(arguments.callee)
                    : this[t](e)
                );
              },
                ...
                return e.arguments && e.stack
                  ...
                  ? e.stacktrace
                    ? e.message.indexOf("\n") > -1 &&
                      ...
                      : "opera10a"
                    : "opera9"
                  : e.message && e.stack && e.stacktrace
                  ? e.stacktrace.indexOf("called from line") < 0
                    ? "opera10b"
                    : "opera11"
                  : e.stack && !e.fileName
                  ? "chrome"
              ...
              deinstrumentFunction: function (e, t) {
                e[t].constructor === Function &&
                  e[t]._instrumented &&
                  e[t]._instrumented.constructor === Function &&
              ...
              other: function (e) {
                var t,
                  ...
                  s = [];
                try {
                  for (; e && e.arguments && s.length < 10; )
                    (t = (o.test(e.toString()) && RegExp.$1) || r),
                      (n = Array.prototype.slice.call(e.arguments || [])),
                      (s[s.length] =
                        t + "(" + this.stringifyArguments(n) + ")"),
                      (e = e.caller);
                  return s;
                } catch (e) {
                  return "";
              ...
              stringifyArguments: function (e) {
                for (
                  var t = [], n = Array.prototype.slice, r = 0;
                  r < e.length;
                  ++r
                ) {
                  var o = e[r];
                  void 0 === o
                    ...
                    : o.constructor &&
                      (o.constructor === Array
                        ? o.length < 3
                          ? (t[r] = "[" + this.stringifyArguments(o) + "]")
                          : (t[r] =
                              "[" +
                              this.stringifyArguments(n.call(o, 0, 1)) +
                              "..." +
                              this.stringifyArguments(n.call(o, -1)) +
                              "]")
          ...
          var r = (function () {
            function e(t, s, i, a, c, u, l) {
              ...
              var p,
                ...
                y = u.match(g) || [],
                b = n[t] || {};
              for (g.lastIndex = 0, y || (u = ""), f = 0; f < y.length; f++)
                (m.lastIndex = 0),
                  (d = y[f].match(m)[2].toLowerCase()),
                  b.restrictChildrenTo.length > 0 &&
                    (b.validChildLookup[d] ||
                      ((h =
                        'The tag "' +
                        d +
                        ...
                        '".'),
                      l.push(h))),
                  (p = n[d] || {}).restrictParentsTo.length > 0 &&
                    (p.validParentLookup[t] ||
                      ((h =
                        'The tag "' +
                        t +
                      ...
                      l.push(h)));
              return (
                (u = u.replace(o, function (t, n, r, o, s) {
                ...
                for (e in n)
                  if (n.hasOwnProperty(e)) {
                    for (
                      "*" === e
                        ? r.push("\\" + e)
                        : (r.push(e), n[e].noParse && f.push(e)),
                        n[e].validChildLookup = {},
                        n[e].validParentLookup = {},
                        n[e].restrictParentsTo = n[e].restrictParentsTo || [],
                        n[e].restrictChildrenTo = n[e].restrictChildrenTo || [],
                        o = n[e].restrictChildrenTo.length,
                        t = 0;
                      t < o;
                      t++
                    )
                      n[e].validChildLookup[n[e].restrictChildrenTo[t]] = !0;
                    for (o = n[e].restrictParentsTo.length, t = 0; t < o; t++)
                      n[e].validParentLookup[n[e].restrictParentsTo[t]] = !0;
                  }
              })(),
              (o = new RegExp(
                "<bbcl=([0-9]+) (" +
            ...
            return (
              (u.process = function (n) {
                var r = { html: "", error: !1 },
                  u = [];
                for (
                  n.text = n.text.replace(/</g, "<"),
                    n.text = n.text.replace(/>/g, ">"),
                    n.text = n.text.replace(a, function (e, t, n, r) {
                      return "<" + n + ">";
                    }),
                    ...
                    n.text = n.text.replace(/>/g, "]");
                  n.text !==
                  (n.text = n.text.replace(i, function (e, t, n, r) {
                    return (
                      "[" +
                      t +
                      (n = n || "") +
                ...
                return (
                  ...
                  (n.text = (function (e) {
                    for (
                      ;
                      e !==
                      (e = e.replace(s, function (e, n, r, o) {
                        return t(
                  ...
                  (u = e("bbcode", n.text, -1, 0, 0, n.text)),
                  (r.html = (function (e) {
                    var t = e.text;
                    return t.replace(o, d);
                  })(n)),
                  (-1 === r.html.indexOf("[") && -1 === r.html.indexOf("]")) ||
                    u.push("Some tags appear to be misaligned."),
                  n.removeMisalignedTags &&
                    (r.html = r.html.replace(/\[.*?\]/g, "")),
                  n.addInLineBreaks &&
        ...
        983: (e, t, n) => {
          ...
          (e.exports = (e, t) => new r(e, t)),
            ...
            (e.exports.Transport = n(496)),
            (e.exports.transports = n(352)),
            (e.exports.parser = n(743));
        },
        192: (e, t, n) => {
          const r = n(352),
            o = n(767),
          ...
          class u extends o {
            ...
            open() {
              ...
              try {
                ...
                return (
                  s("error while creating transport: %s", e),
            ...
            probe(e) {
              ...
              function p(e) {
                t &&
                  e.name !== t.name &&
                  (s('"%s" works - aborting "%s"', e.name, t.name), i());
              }
              function h() {
        ...
        416: (e, t, n) => {
          ...
          if (
            ...
            if ("function" == typeof attachEvent) attachEvent("onunload", h);
              ...
              addEventListener(
                "onpagehide" in a ? "pagehide" : "unload",
                h,
                !1
              );
            }
          function h() {
            for (let e in p.requests)
        ...
        442: (e, t, n) => {
          ...
          class f extends r {
            ...
            doOpen() {
              ...
              try {
                this.ws =
                  u && !h ? (t ? new c(e, t) : new c(e)) : new c(e, t, n);
              } catch (e) {
                return this.emit("error", e);
              }
              (this.ws.binaryType = this.socket.binaryType || l),
                  ...
                  o.encodePacket(e, t.supportsBinary, function (r) {
                    ...
                    if (
                      ...
                      ("string" == typeof r ? Buffer.byteLength(r) : r.length) <
                        t.opts.perMessageDeflate.threshold && (o.compress = !1);
                    }
                    try {
            ...
            check() {
              return !(
                !c ||
                ("__initialize" in c && this.name === f.prototype.name)
              );
            }
          }
          e.exports = f;
        ...
        839: (e) => {
          e.exports.pick = (e, ...t) =>
            t.reduce((t, n) => (e.hasOwnProperty(n) && (t[n] = e[n]), t), {});
        },
        777: (e, t, n) => {
          const r = n(58),
            o = n(549);
        ...
        965: (e, t, n) => {
          const { PACKET_TYPES_REVERSE: r, ERROR_PACKET: o } = n(712);
          let s;
          ...
          e.exports = (e, t) => {
            ...
            const n = e.charAt(0);
            if ("b" === n)
              return { type: "message", data: i(e.substring(1), t) };
            return r[n]
              ? e.length > 1
        ...
        929: (e, t, n) => {
          ...
          e.exports = ({ type: e, data: t }, n, a) => {
            return o && t instanceof Blob
              ...
              ? n
                ? a(t instanceof ArrayBuffer ? t : t.buffer)
                : i(new Blob([t]), a)
              : a(r[e] + (t || ""));
            var c;
          };
        ...
        187: (e) => {
          ...
          e.exports = function (e) {
            ...
            for (var i, a, c = t.exec(e || ""), u = {}, l = 14; l--; )
              u[n[l]] = c[l] || "";
            return (
              -1 != o &&
                -1 != s &&
          ...
          function c(e, t) {
            ...
            return (
              t.forceNew || t["force new connection"] || !1 === t.multiplex || l
                ? (i("ignoring socket cache for %s", s),
                  (p = new o.Manager(s, t)))
                : (a[c] ||
                    (i("new io instance for %s", s),
                    (a[c] = new o.Manager(s, t))),
                  (p = a[c])),
        ...
        703: (e, t, n) => {
          ...
          t.Manager = class extends s {
            ...
            onopen() {
              ...
              const e = this.engine;
              this.subs.push(
                a.on(e, "ping", this.onping.bind(this)),
                a.on(e, "data", this.ondata.bind(this)),
                a.on(e, "error", this.onerror.bind(this)),
                a.on(e, "close", this.onclose.bind(this)),
                a.on(this.decoder, "decoded", this.ondecoded.bind(this))
              );
            }
            onping() {
              super.emit("ping");
            ...
            socket(e, t) {
              let n = this.nsps[e];
              return (
                n || ((n = new o.Socket(this, e, t)), (this.nsps[e] = n)), n
              );
            }
            _destroy(e) {
              ...
              for (const e of t) {
                if (this.nsps[e].active)
                  return void u("socket %s is still active, skipping close", e);
              }
              this._close();
            }
            _packet(e) {
        ...
        277: (e, t, n) => {
          ...
          t.Socket = class extends o {
            ...
            subEvents() {
              ...
              const e = this.io;
              this.subs = [
                s.on(e, "open", this.onopen.bind(this)),
                s.on(e, "packet", this.onpacket.bind(this)),
            ...
            onevent(e) {
              const t = e.data || [];
              i("emitting event %j", t),
                null != e.id &&
                  (i("attaching ack callback to event"),
            ...
            onack(e) {
              ...
              "function" == typeof t
                ? (i("calling ack %s with %j", e.id, e.data),
                  t.apply(this, e.data),
                  delete this.acks[e.id])
                : i("bad ack %s", e.id);
            }
            onconnect(e) {
              i("socket connected with id %s", e),
                (this.id = e),
                (this.connected = !0),
                (this.disconnected = !1),
                super.emit("connect"),
          ...
          t.Encoder = class {
            encode(e) {
              return (
                ...
                (e.type !== a.EVENT && e.type !== a.ACK) || !s.hasBinary(e)
    ...
    function __webpack_require__(e) {
      ...
      return (
        __webpack_modules__[e](t, t.exports, __webpack_require__), t.exports
      );
    }
